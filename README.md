...
The circuit after detecting a clap, switches LED1 diode on and off. Additionally, it enables/disables PK1 relay. A
device of max 230V/1000W can be enabled/disabled using J2 connector. 